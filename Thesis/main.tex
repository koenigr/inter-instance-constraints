...
\lhead{\emph{Definitionen}} % Set the left side page header to "Symbols"
...
\input{Chapters/verwandteArbeit} 
\input{Chapters/Theorie}
\input{Chapters/Grammatik}
\input{Chapters/Praxis} 
...
\input{Appendices/Predicates}
\input{Appendices/FurtherConstraints}
\input{Appendices/Programmstarten}
\input{Appendices/Paketstruktur}
\input{Appendices/Grammatik}
\input{Appendices/Pseudocode}

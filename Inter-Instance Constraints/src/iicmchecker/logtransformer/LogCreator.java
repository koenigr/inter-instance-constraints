...
private static String loglocation = "logfiles"; // TODO defaultwert, weil ja aus Versehen der andere Constructor benutzt werden könnte
private static String logfile = "logfile";

public LogCreator(String loglocation, String logfile) {
	this.loglocation = loglocation;
	this.logfile = logfile;
}

public void createLog() throws LockingException, CompatibilityException, ParameterException, PerspectiveException, IOException, ParserException {
